...
public class PizzaOrder
{
    ...
    {   DecimalFormat decimalFormat=new DecimalFormat("#.##");
                    ...
                    if (inches == 14)
                    {
                    ...
                    else
                        {
                            if(inches==16)
                            {
                                ...
                                {
                                    System.out.println("Sorry,we don't have this size.So a 12 inche pizza will be given.");
                                    cost=12.99;
                                }
                        }
                }
        ...
        switch (crustType)
        {
            case'H': case'h':crust="Hand-tossed";
                             break;
            case'T': case't':crust="Thin-crust";
                             break;
            case'D': case'd':crust="Deep-dish";
                             break;
            default:
